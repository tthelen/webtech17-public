...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_purecss_build_pure_min_css__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_purecss_build_pure_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_purecss_build_pure_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_purecss_build_grids_responsive_min_css__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_purecss_build_grids_responsive_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_purecss_build_grids_responsive_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__wiki_css__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__wiki_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__wiki_css__);


  // the socket.io client

  // tell webpack to include the css.
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function(){
	...
	if (mode=='edit') {  // when editing we want to send all changes to server
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#wikiedit').on("input", function (event) {
			...
			socket.emit('input', { page: pagename, text: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#wikiedit').val() });
		});
	}
	...
	if (mode=='show') {  // when showing we want to receive changes from server
		...
		socket.on('input', function (textdata) {
			...
			__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#wikitext').html(textdata);
		});
	}
});
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./wiki.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./wiki.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".wikitext {\r\n\tbackground: white;\r\n\tpadding: 10px;\r\n\tmargin: 10px;\r\n}\r\n\r\n.wikiedit {\r\n\tdisplay: block;\r\n\tmin-height: 20em;\r\n\twidth: 80%;\r\n}\r\n\r\n.actions {\r\n\tmargin: 15px;\r\n\ttext-align: right;\r\n}\r\n\r\n.l-box {\r\n\tpadding: 2em;\r\n\tbackground-color: white;\r\n\r\n}\r\n\r\n.black-box {\r\n\tbackground-color: black;\r\n\tcolor: white;\r\n}\r\n\r\n.lightgrey-box {\r\n\tbackground-color: lightgrey;\r\n\tcolor: black;\r\n}\r\n\r\n.right-flow {\r\n\ttext-align:right;\r\n}", ""]);
